...
app.post('/webhook', async (req, res) => {
  try {
    ...
    if (update.message && update.message.text) {
      ...
      // Обработка команды /fun
      else if (lowerText === '/fun' || lowerText.startsWith('/fun@')) {
        const jokes = [
      ...
      // Реакция на слово "скучно"
      else if (lowerText.includes('скучно')) {
        await bot.sendMessage(chatId, `${userName}, давай повеселимся! Введи команду /fun`);
      }
